...
Shader_Break_Col: bpy.props.BoolProperty(default=False)
...
class NODE_PT_Shader_Utilities_Panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(scene, "Shader_Break_Col", text="Break Column")

        layout.operator("nodes.test_ot", text="TESTE")
