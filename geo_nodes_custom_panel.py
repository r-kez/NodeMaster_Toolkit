...
#class My_settings(bpy.types.PropertyGroup):
    #GeoNode_Break_Col: bpy.props.BoolProperty(name='Boolean Checkbox', default=False )


GeoNode_Break_Col: bpy.props.BoolProperty(default=False )
...
# Geometry Nodes -- Attribute Main -- 6 Items
class GEONODES_PT_UtilitiesPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(scene, "GeoNode_Break_Col", text="Break Columns")
        # Bool Button for Auto Connect New Node 
        layout.prop(scene, "AutoConnect", text="Auto Connect New Node")
...
class GEONODES_PT_AttributePanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if scene.GeoNode_Break_Col:
            BoolRes = 2        
        else:
            BoolRes = 1

        # grid layout
        grid = layout.grid_flow(row_major=True, columns=BoolRes, align=True)
...
# Geometry Nodes -- Input Main -- 3 subpanels --- 15 Items
...
# Geometry Nodes -- Input Subpanel -- Scene --- 6 Items
...
class GEONODES_PT_OutputPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if context.scene.GeoNode_Break_Col:
            BoolRes = 2
        else:
            BoolRes = 1
...
# Geometry Nodes -- Geometry -- Main -- 4 Listas and 2 Items
...
# Geometry Nodes -- Geometry Subpanel -- Read --- 6 Items
class GEONODES_PT_GeometryReadPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        grid.operator("nodes.geometry_id_add", text="Geometry ID")                      # Geometry ID
        grid.operator("nodes.geometry_index_add", text="Geometry Index")                # Geometry Index 
        grid.operator("nodes.geometry_attribute_add", text="Geometry Attribute")        # Geometry Attribute 
        grid.operator("nodes.geometry_normal_add", text="Normal")                       # Normal 
        grid.operator("nodes.geometry_position_add", text="Position")                   # Position
        grid.operator("nodes.geometry_radius_add", text="Radius")                       # Radius

        return None

############################## Sample ####################################

# Geometry Nodes -- Geometry Subpanel -- Sample --- 5 Items
...
# Geometry Nodes -- Geometry Subpanel -- Write --- 5 Items
...
# Geometry Nodes -- Geometry Subpanel -- Operations --- 5 Items
...
# Geometry Nodes -- Curve Subpanel -- Read --- 10 Items
...
# Geometry Nodes -- Curve Subpanel -- Write --- 8 Items
...
# Geometry Nodes -- Curve Subpanel -- Operations --- 10 Items
...
# Geometry Nodes -- Curve Subpanel -- Topology --- 8 Items
...
# Geometry Nodes -- Curve Subpanel -- Instances --- 10 Items
...
# Geometry Nodes -- Mesh Subpanel -- Read --- 13 Items
class GEONODES_PT_MeshReadPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        grid.operator("nodes.mesh_edge_angle_add", text="Edge Angle")                                   # Instance on Points
        grid.operator("nodes.mesh_edge_neigbors_add", text="Edge Neighbors")                                  # Instances To Points
        grid.operator("nodes.mesh_edge_vertices_add", text="Edge Vertices")                             # Realize Instances  
        grid.operator("nodes.mesh_edge_to_face_group_add", text="Edge To Face Groups")                               # Rotate Instances
        grid.operator("nodes.mesh_face_area_add", text="Face Area")                                # Scale Instances
        grid.operator("nodes.mesh_face_set_boundaries_add", text="Face Group Boundaries")                        # Translate Instances  
        grid.operator("nodes.mesh_face_neighbors_add", text="Face Neighbors")                # Input Instance Rotation
        grid.operator("nodes.mesh_face_is_planar_add", text="Is Face is Planar")                      # Input Instance Scale  
        grid.operator("nodes.mesh_is_shade_smooth_add", text="Is Shade Smooth")                               # Rotate Instances
        grid.operator("nodes.mesh_is_edge_smooth_add", text="Is Edge Smooth")                                # Scale Instances
        grid.operator("nodes.mesh_island_add", text="Mesh Island")                        # Translate Instances  
        grid.operator("nodes.mesh_shortest_edges_paths_add", text="Shortest Edge Path")                # Input Instance Rotation
        grid.operator("nodes.mesh_vertex_neighbors_add", text="Vertex Neighbors")                      # Input Instance Scale  
...
# Geometry Nodes -- Mesh Subpanel -- Sample --- 2 Items
...
# Geometry Nodes -- Mesh Subpanel -- Primitives --- 8 Items
...
# Geometry Nodes -- Mesh Subpanel -- Topology --- 8 Items
...
# Geometry Nodes -- Mesh Subpanel -- UV --- 2 Items
